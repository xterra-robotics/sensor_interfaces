...
bool xterra__msg__quaternion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xterra.msg._quaternion.Quaternion", full_classname_dest, 33) == 0);
  }
  xterra__msg__Quaternion * ros_message = _ros_message;
  {  // x
...
PyObject * xterra__msg__quaternion__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xterra.msg._quaternion");
