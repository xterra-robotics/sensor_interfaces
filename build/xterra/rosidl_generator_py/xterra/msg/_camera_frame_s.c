...
bool xterra__msg__camera_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xterra.msg._camera_frame.CameraFrame", full_classname_dest, 36) == 0);
  }
  xterra__msg__CameraFrame * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of CameraFrame */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xterra.msg._camera_frame");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraFrame");
  ...
  {  // data
    ...
    memcpy(dst, src, 2764800 * sizeof(uint8_t));
    Py_DECREF(field);
  }
  {  // width
    PyObject * field = NULL;
