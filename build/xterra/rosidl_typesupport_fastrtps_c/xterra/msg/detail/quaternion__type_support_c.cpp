...
#include "xterra/msg/detail/quaternion__rosidl_typesupport_fastrtps_c.h"
...
using _Quaternion__ros_msg_type = xterra__msg__Quaternion;
...
static uint32_t _Quaternion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xterra__msg__Quaternion(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xterra__msg__Quaternion;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
static size_t _Quaternion__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xterra__msg__Quaternion(
