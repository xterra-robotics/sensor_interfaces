...
#include "xterra/msg/detail/quaternion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xterra::msg::Quaternion & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xterra::msg::Quaternion & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xterra::msg::Quaternion;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const xterra::msg::Quaternion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xterra::msg::Quaternion *>(
    untyped_ros_message);
...
{
  return &xterra::msg::typesupport_fastrtps_cpp::_Quaternion__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xterra, msg, Quaternion)() {
  return &xterra::msg::typesupport_fastrtps_cpp::_Quaternion__handle;
}
