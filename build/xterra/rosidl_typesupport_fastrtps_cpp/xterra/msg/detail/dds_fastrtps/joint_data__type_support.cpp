...
#include "xterra/msg/detail/joint_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xterra::msg::JointData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xterra::msg::JointData & ros_message)
{
  // Member: q
  {
    cdr >> ros_message.q;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xterra::msg::JointData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xterra::msg::JointData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xterra::msg::JointData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JointData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const xterra::msg::JointData *>(
...
static size_t _JointData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JointData__callbacks = {
  "xterra::msg",
  "JointData",
...
static rosidl_message_type_support_t _JointData__handle = {
...
{
  return &xterra::msg::typesupport_fastrtps_cpp::_JointData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xterra, msg, JointData)() {
  return &xterra::msg::typesupport_fastrtps_cpp::_JointData__handle;
}
