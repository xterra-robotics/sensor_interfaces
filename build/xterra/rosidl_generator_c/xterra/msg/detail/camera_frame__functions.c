...
xterra__msg__CameraFrame__create()
{
  ...
  xterra__msg__CameraFrame * msg = (xterra__msg__CameraFrame *)allocator.allocate(sizeof(xterra__msg__CameraFrame), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xterra__msg__CameraFrame));
  bool success = xterra__msg__CameraFrame__init(msg);
  if (!success) {
...
xterra__msg__CameraFrame__destroy(xterra__msg__CameraFrame * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    xterra__msg__CameraFrame__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
xterra__msg__CameraFrame__Sequence__init(xterra__msg__CameraFrame__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xterra__msg__CameraFrame * data = NULL;

  if (size) {
    data = (xterra__msg__CameraFrame *)allocator.zero_allocate(size, sizeof(xterra__msg__CameraFrame), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xterra__msg__CameraFrame__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        xterra__msg__CameraFrame__fini(&data[i - 1]);
      }
...
xterra__msg__CameraFrame__Sequence__fini(xterra__msg__CameraFrame__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      xterra__msg__CameraFrame__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xterra__msg__CameraFrame__Sequence * array = (xterra__msg__CameraFrame__Sequence *)allocator.allocate(sizeof(xterra__msg__CameraFrame__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xterra__msg__CameraFrame__Sequence__init(array, size);
  if (!success) {
...
xterra__msg__CameraFrame__Sequence__destroy(xterra__msg__CameraFrame__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xterra__msg__CameraFrame__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xterra__msg__CameraFrame__Sequence__are_equal(const xterra__msg__CameraFrame__Sequence * lhs, const xterra__msg__CameraFrame__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xterra__msg__CameraFrame__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xterra__msg__CameraFrame__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xterra__msg__CameraFrame);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    xterra__msg__CameraFrame * data =
      (xterra__msg__CameraFrame *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xterra__msg__CameraFrame__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xterra__msg__CameraFrame__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!xterra__msg__CameraFrame__copy(
