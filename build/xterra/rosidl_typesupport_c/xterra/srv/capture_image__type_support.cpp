...
static const _CaptureImage_Request_type_support_symbol_names_t _CaptureImage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xterra, srv, CaptureImage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xterra, srv, CaptureImage_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xterra, srv, CaptureImage_Request)() {
  return &::xterra::srv::rosidl_typesupport_c::CaptureImage_Request_message_type_support_handle;
}
...
static const _CaptureImage_Response_type_support_symbol_names_t _CaptureImage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xterra, srv, CaptureImage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xterra, srv, CaptureImage_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xterra, srv, CaptureImage_Response)() {
  return &::xterra::srv::rosidl_typesupport_c::CaptureImage_Response_message_type_support_handle;
}
...
static const _CaptureImage_type_support_symbol_names_t _CaptureImage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xterra, srv, CaptureImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xterra, srv, CaptureImage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, xterra, srv, CaptureImage)() {
  return &::xterra::srv::rosidl_typesupport_c::CaptureImage_service_type_support_handle;
}
