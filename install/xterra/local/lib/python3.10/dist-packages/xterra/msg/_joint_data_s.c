...
bool xterra__msg__joint_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xterra.msg._joint_data.JointData", full_classname_dest, 32) == 0);
  }
  xterra__msg__JointData * ros_message = _ros_message;
  {  // q
...
PyObject * xterra__msg__joint_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xterra.msg._joint_data");
